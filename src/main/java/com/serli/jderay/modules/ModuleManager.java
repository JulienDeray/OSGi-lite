...
public interface ModuleManager {
     ...
     * @throws AlreadyAddedVersionException
     */
    public void loadModulesFromDirectory(String globalPath) throws InstantiationException, IllegalAccessException, URISyntaxException, DependencyException, IOException, InvalidModException, MainModuleException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, BadArgumentsException, ParseException;
